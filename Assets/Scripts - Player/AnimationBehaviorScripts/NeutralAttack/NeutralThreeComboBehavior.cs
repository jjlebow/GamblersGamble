...
public class NeutralThreeComboBehavior : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        playerAttacker.attackTriggerNeutralCombo3.SetActive(true);
    }
    ...
    {
        playerAttacker.attackTriggerNeutralCombo3.SetActive(false);  
